...
import {Layout, Sider, Title, Input, SideHeader, DialogSelection, DialogBlock}
    ...
    return (
        <Layout>
            <Sider>
                ...
                />
                <Message
                    src={'https://cdna.artstation.com/p/assets/images/images/033/451/774/large/marcin-blaszczak-tr-coat-05.jpg?1609664523'}
                    name={'Trinity'}
                    message={'Do you still love me?'}
                    unread={100}
                />
                <Message
                    src={'https://cdnb.artstation.com/p/assets/images/images/033/670/305/large/marcin-blaszczak-m-coat-01.jpg?1610270916'}
                    name={'Morpheus'}
                    message={'Aren\'t you interested in pills?'}
                    unread={0}
                />
                <Message
                    src={'https://upload.wikimedia.org/wikipedia/en/1/1f/Agent_Smith_%28The_Matrix_series_character%29.jpg'}
                    name={'Smith'}
